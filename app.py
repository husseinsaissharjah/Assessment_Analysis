...
.stSidebar button[data-testid="stBaseButton-primary"]:focus,
.stSidebar button[data-testid="stBaseButton-primary"]:focus-visible,
.stSidebar button[data-testid="stBaseButton-primary"]:active {
    background-color: #1f77b4 !important;
    color: white !important;
}
...
.stSidebar button[data-testid="stBaseButton-secondary"] {
    background-color: transparent !important;
    color: inherit !important;
}
.stSidebar button[data-testid="stBaseButton-secondary"]:focus,
.stSidebar button[data-testid="stBaseButton-secondary"]:focus-visible,
.stSidebar button[data-testid="stBaseButton-secondary"]:active {
    background-color: transparent !important;
    color: inherit !important;
}
